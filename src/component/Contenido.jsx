...
class Contenido extends React.Component {
  ...
  Personajes = async () => {
    ...
    var datos = await fetch(
      `https://rickandmortyapi.com/api/character/${this.state.personaje1.num}`
    );
    ...
    var datos2 = await fetch(
      `https://rickandmortyapi.com/api/character/${this.state.personaje2.num}`
    );
    ...
    var datos3 = await fetch(
      `https://rickandmortyapi.com/api/character/${this.state.personaje3.num}`
    );
    ...
    var datos4 = await fetch(
      `https://rickandmortyapi.com/api/character/${this.state.personaje4.num}`
    );
